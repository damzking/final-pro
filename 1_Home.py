    ...
    with st.container():
        ...
        with col1:
            ...
            with st.expander(":violet[**Data Page**] -"):
                st.caption('This page displays the datasets used to train our machine learning models, including statistical information. The datasets were sourced from a Azubi Africa platform, cleaned before modeling.')
        ...
        with col2:
            ...
            st.write("""Estimated Time of Arrival (ETA) is a critical component in ride-hailing apps like Uber and Yassir, playing a vital role in ensuring a seamless and efficient user experience. ETA refers to the predicted time it takes for a driver to arrive at a passenger's pickup location.""")

            st.markdown("""  Accurate ETA predictions are crucial for several reasons:
            ...
            st.write(""" - Impact on Business Strategy:
                       Savings from improved efficiency can be reinvested into other areas of the business, such as technology upgrades, marketing, or expansion efforts. Leveraging real-time data and advanced analytics can drive strategic decisions and foster innovation within the company.""")
...
1.  Surface pressure above the average does not have a significantly more positive impact on reducing the Estimated Time of Arrival (ETA) compared to surface pressure below the average.
                """)
        ...
        with st.form('reset_password_form'):
            ...
            if st.form_submit_button('Reset'):
                if new_password == confirm_password:
                    try:
                        if authenticator.reset_password(username, new_password, location='sidebar'):
